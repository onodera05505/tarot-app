...
| 画面と入力の設計で先に決めること | 未 | 対象にする画面幅の範囲・白背景の色の基準・押した直後の表示・スマホ幅の確認手段を決めていない（本人の実機レビュー頼み。2026-09-14） |
| 無料枠・プラン・費用の確認 | 未 | Cloudflare Pages 無料枠と Sentry 無料枠の商用条件・制限を原文で確認した記録が無い（2026-09-14） |
